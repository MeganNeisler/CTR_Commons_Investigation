...
#Query EnWiki and Commons Data in January to confirm is decline aroud Jan 28 is isolated to Commons
#Look at 30 days around ctr decline in January commons and en wiki.
start_date <- as.Date("2018-01-20")
end_date <- as.Date("2018-02-20")
